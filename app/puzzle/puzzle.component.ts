...
@Component({
  ...
  template: `
    ...
    <h2 [hidden]="switch1.value != switch1Number || switch2.value != switch2Number || switch3.value != switch3Number || switch4.value != switch4Number">Congraulations {{name.value}}, you did it!</h2>
  `
})
